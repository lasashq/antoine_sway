import
  ...
  ../nitches/[getUser, getHostname,
                  getDistro, getKernel,
                  getUptime, getShell,
                  getPkgs, getWM, getRam, getLogo]  # import nitches to get info about user system
...
proc drawInfo*(asciiArt: bool) =
  ...
  const  # icons before cotegores
    ...
    uptimeIcon = "󱦟 "  # recomended: " " or "|>"
    shellIcon  = " "  # recomended: " " or "|>"
    pkgsIcon   = "󰏓 "  # recomended: "󰏖 " or "|>"
  ...
  const  # categories
    ...
    colorsCat = "  olors│ "  # recomended: " colors │ "
    wmCat     = " wm     │ "
  ...
  # colored out
    ...
    stdout.styledWrite("  │ ", color2, wmIcon, color0, wmCat, fgGreen, wmInfo, color0, "\n")
